      ...
      <main className="relative">
        ...
        <section id="announcement" className="py-16 md:py-20 bg-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <h2 className="text-4xl lg:text-6xl mb-6 md:mb-8 font-alex text-pink-500">
              We are Married!
            </h2>
        ...
        <section id="event" className="py-16 md:py-20 bg-pink-50">
          <div className="container mx-auto px-4">
            <h2 className="text-4xl lg:text-6xl text-center mb-12 md:mb-16 text-pink-500 font-alex">
              Rincian Acara
            </h2>
            <div className="grid gap-4 md:gap-8 w-full">
              ...
              <div className="bg-white p-6 md:p-8 rounded-3xl text-center grid gap-4">
                <div>
                  ...
                  <h3 className="text-2xl md:text-3xl font-semibold mb-2 md:mb-4 text-pink-500 font-alex">
                    Lokasi
                  </h3>
